...
<?php (!empty($this) && $this instanceof WeModuleSite || 0) ? (include $this->template('common/header-gw', TEMPLATE_INCLUDEPATH)) : (include template('common/header-gw', TEMPLATE_INCLUDEPATH));?>
			...
			<div class="clearfix">
				<iframe src="<?php  echo $iframe;?>" marginheight="0" marginwidth="0" frameborder="0" width="100%" style="<?php  if($do == 'profile') { ?>height:800px;<?php  } ?>" scrolling="no" allowTransparency="true"></iframe>
			</div>
		</div>
	</div>
</div>
