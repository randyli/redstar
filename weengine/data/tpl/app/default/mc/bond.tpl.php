...
<!--  收货地址 -->
<?php  if($do == 'address' && empty($_GPC['uid'])) { ?>
<div class="address">
	<a href="<?php  echo url('mc/bond/address', array('uid' => $data['uid']));?>" class="list-item clearfix">
		<div class="pull-left">
			...
			<div class="address-details">
				<div style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis;"><?php  echo $data['resideprovince'];?> <?php  echo $data['residecity'];?> <?php  echo $data['residedist'];?> <?php  echo $data['address'];?></div>
			</div>
		</div>
	</a>
</div>
	...
	<form action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-8">
				<input type="text" name="data[realname]" class="form-control" value="<?php  echo $data['realname'];?>" />
			</div>
		</div>
		<div class="form-group">
