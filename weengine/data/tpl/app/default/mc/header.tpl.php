...
/*个人中心*/
.pcenter-main .head{position:relative; height:170px; width:100%; background:url('resource/images/head-bg.png') no-repeat center center; background-size:100% auto; -moz-background-size:100% auto; -webkit-background-size:100% auto;}
