...
<html lang="zh-CN">
  <head>
    ...
    <link href="<?php  echo $_W['siteroot'];?>app/resource/css/ibeacon.css" rel="stylesheet">
  </head>
  <body>
    <img src="<?php  echo $_W['siteroot'];?>app/resource/img/ibeacon_top.png" height="250px" width="100%">
    <div class="qform">
    ...
    <script src="<?php  echo $_W['siteroot'];?>app/resource/js/lib/zepto.min.js"></script>
    <script>
       $(function() {
